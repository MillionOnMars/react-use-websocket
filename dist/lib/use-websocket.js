...
exports.useWebSocket = exports.useBaseWebsocket = void 0;
...
var useBaseWebsocket = function (url, options, connect) {
    var _a;
    ...
    var setLastMessage = (_a = options.lastMessageStore) === null || _a === void 0 ? void 0 : _a[1];
    ...
    var stringifiedQueryParams = options.queryParams
    ...
    var getWebSocket = (0, react_1.useCallback)(function () {
        if (optionsCache.current.share !== true ||
            (constants_1.isEventSourceSupported && webSocketRef.current instanceof EventSource)) {
        ...
        if (url !== null && connect === true) {
                        ...
                        case 1:
                            ...
                            if (convertedUrl.current === null) {
                                ...
                                (0, react_dom_1.flushSync)(function () {
                                    return setReadyState(function (prev) { return (__assign(__assign({}, prev), { ABORTED: constants_1.ReadyState.CLOSED })); });
                                });
                                return [2 /*return*/];
                            }
                            protectedSetLastMessage = function (message) {
                                if (!expectClose_1 && setLastMessage) {
            ...
            return function () {
                ...
                if (webSocketProxy.current)
                    webSocketProxy.current = null;
                removeListeners_1 === null || removeListeners_1 === void 0 ? void 0 : removeListeners_1();
                setLastMessage === null || setLastMessage === void 0 ? void 0 : setLastMessage(null);
            };
        }
            ...
            setReadyState(function (prev) {
                var _a;
                return (__assign(__assign({}, prev), (convertedUrl.current && (_a = {},
                    _a[convertedUrl.current] = constants_1.ReadyState.CLOSED,
                    _a))));
            });
        }
...
exports.useBaseWebsocket = useBaseWebsocket;
var useWebSocket = function (url, options, connect) {
    if (options === void 0) { options = constants_1.DEFAULT_OPTIONS; }
    if (connect === void 0) { connect = true; }
    var lastMessageStore = (0, react_1.useState)(null);
    var lastMessage = lastMessageStore[0];
    ...
    var _a = (0, exports.useBaseWebsocket)(url, __assign(__assign({}, options), { lastMessageStore: lastMessageStore }), connect), sendMessage = _a.sendMessage, readyState = _a.readyState, sendJsonMessage = _a.sendJsonMessage, getWebSocket = _a.getWebSocket;
    return {
        sendMessage: sendMessage,
        sendJsonMessage: sendJsonMessage,
